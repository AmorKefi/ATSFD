...
@Component({
  selector: 'app-modif-adminsfd',
  templateUrl: './modif-adminsfd.component.html',
  styleUrls: ['./modif-adminsfd.component.scss']
})
export class ModifAdminsfdComponent implements OnInit {
  ...
  constructor(private appRoleService:AppRoleService,
              ...
              private dialogRef: MatDialogRef<ModifAdminsfdComponent>,
