...
@Component({
  selector: 'app-add-admin-sfd',
  templateUrl: './add-admin-sfd.component.html',
  styleUrls: ['./add-admin-sfd.component.scss']
})
export class AddAdminSfdComponent implements OnInit {
  ...
  constructor(private appRoleService:AppRoleService,
              ...
              private dialogRef: MatDialogRef<AddAdminSfdComponent>,
  ...
  ngOnInit() {
     this.form = this._fb.group({
          ...
          this.appRoleService.getAllRolesAdminSFD().subscribe(
   ...
   save(model: UserApp, isValid: boolean) {
     ...
     this.appUserService.addResponsable(this.user).subscribe(
       res=>{
        ...
        div.innerHTML="L'administrateur SFD est ajouté avec succés !";
       ...
       err => {
         ...
         div.innerHTML="L'administrateur SFD n'a pas été ajouté !"
         setInterval(function(){
           div.classList.remove('animate');
         },4000)
       },
